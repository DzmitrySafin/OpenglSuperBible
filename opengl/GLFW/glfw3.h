 ...
 *
 *  [in] error An [error code](@ref errors).
 ...
 *  [in] xpos The new x-coordinate, in screen coordinates, of the
 *  upper-left corner of the client area of the window.
 *  [in] ypos The new y-coordinate, in screen coordinates, of the
 *  upper-left corner of the client area of the window.
 *
 *  @ref window_pos
 ...
 *  [in] focused `GLFW_TRUE` if the window was given input focus, or
 ...
 *  [in] iconified `GLFW_TRUE` if the window was iconified, or
 ...
 *  [in] iconified `GLFW_TRUE` if the window was maximized, or
 *  `GLFW_FALSE` if it was restored.
 *
 *  @ref window_maximize
 ...
 *  [in] button The [mouse button](@ref buttons) that was pressed or
 *  released.
 *  [in] action One of `GLFW_PRESS` or `GLFW_RELEASE`.
 *  [in] mods Bit field describing which [modifier keys](@ref mods) were
 *  held down.
 *
 ...
 *
 *  [in] window The window that received the event.
 *  [in] xpos The new cursor x-coordinate, relative to the left edge of
 *  the client area.
 *  [in] ypos The new cursor y-coordinate, relative to the top edge of the
 *  client area.
 *
 *  @ref cursor_pos
 ...
 *
 *  [in] window The window that received the event.
 *  [in] entered `GLFW_TRUE` if the cursor entered the window's client
 ...
 *
 *  [in] window The window that received the event.
 *  [in] key The [keyboard key](@ref keys) that was pressed or released.
