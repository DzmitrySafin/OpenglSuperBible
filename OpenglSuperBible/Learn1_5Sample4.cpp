...
static const GLchar *vs_source[] =
{
    ...
    "out vec4 vs_color;                       \n"
    "                                         \n"
    "uniform float globalOffsetX;             \n"
    "                                         \n"
    "void main(void)                          \n"
    "{                                        \n"
    "    gl_Position = vec4(position.x + globalOffsetX, position.y, position.z, position.w);  \n"
    "    vs_color = color;                    \n"
    "\n"
    "}"
};
...
void Learn1_5Sample4::Initialize()
{
...
void Learn1_5Sample4::Render(double /*time*/)
{
    glUseProgram(shader_program);

    GLint offsetX = glGetUniformLocation(shader_program, "globalOffsetX");
...
GLuint Learn1_5Sample4::CompileProgram()
{
    GLint success;
    GLchar info_log[512];
